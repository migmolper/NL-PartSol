...
%DISCRETIZATION
DISC=3;  %1- quad (1IP), 2- quad (4IP) 3- 2P1P0, 4- reverse (3), 5- 4P1P0
...
% Add the geometry
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
global nodes sp elements NNE df x_0 elem AMP
AMP=1;          % Amplification of the geometry
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
global W1 M1 H1 H2 s1 s2 ws wi F1 CR1
W1 = 70;        % width of the crack area (mm)
M1 = 200;       % Middle point  (mm)
CR1= 250;       % Middle of the failure zone (mm)
F1 = 283.33;    % Crack point  (mm)
H1 = 100;       % Region Top (mm)
H2 = 0;        % Region Button (mm)
s1 = 33.33;        % Middle support 1 (mm)
s2 = 366.6667;       % Middle support 2 (mm)
ws = 20;        % Wide of the support (mm)
wi = 6;        % Wide of the impactor (mm)
...
Time_final= 8.0e-4;   %seconds
time_step = 1.0e-7;   %seconds
...
SAVE_I=100;     % Save info each XX steps
