  ...
  int GPxElement)
{
  ...
  switch(GPxElement)
  {
    ...
    Xi_p.nM[0][0] =   0.0;
    Xi_p.nM[0][1] =   0.0;
    Xi_p.nM[1][0] =   sqrt(0.6);
    Xi_p.nM[1][1] =   0.0;
    Xi_p.nM[2][0] =   sqrt(0.6);
    Xi_p.nM[2][1] =   sqrt(0.6);
    Xi_p.nM[3][0] =   0.0;
    Xi_p.nM[3][1] =   sqrt(0.6);
    Xi_p.nM[4][0] = - sqrt(0.6);
    Xi_p.nM[4][1] =   sqrt(0.6);
    Xi_p.nM[5][0] = - sqrt(0.6);
    Xi_p.nM[5][1] =   0.0;
    Xi_p.nM[6][0] = - sqrt(0.6);
    Xi_p.nM[6][1] = - sqrt(0.6);
    Xi_p.nM[7][0] =   0.0;
    Xi_p.nM[7][1] = - sqrt(0.6);
    Xi_p.nM[8][0] =   sqrt(0.6);
    Xi_p.nM[8][1] = - sqrt(0.6);
    break;
...
void local_search__Q4__(Particle MPM_Mesh, Mesh FEM_Mesh)
{
  ...
  for(int p = 0 ; p<MPM_Mesh.NumGP ; p++)
  {
    ...
    if(norm__MatrixLib__(V_p,2) > 0)
    {
      ...
      I0_p = get_closest_node__MeshTools__(X_p,MPM_Mesh.ListNodes[p],FEM_Mesh.Coordinates);
      MPM_Mesh.I0[p] = I0_p;
