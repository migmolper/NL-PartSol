 ...
 */
{
  ...
  */
  ...
  {
    sprintf(Error_message,"Sintax error in file %s : One-Phase-Analysis statement is required for a -u analisis",Name_File);
    standard_error(); 
  }
  ...
  */
  ...
  while(fgets(Line,sizeof(Line),Sim_dat) != NULL)
  {
    ...
    */
    ...
    else if ((Num_words > 0) && (strcmp(Words[0],"One-Phase-Analysis") == 0))
    {
  ...
  while(fgets(Line,sizeof(Line),Sim_dat) != NULL)
  {
    ...
    */
    ...
    if ((Num_words >= 3) && (strcmp(Words[0],"One-Phase-Analysis") == 0))
    {
     ...
     {
        sprintf(Error_message,"Sintax error in line %i : %s",Num_line,"One-Phase-Analysis (File=Mesh.msh, *)");
        standard_error(); 
     }
     ...
     {
        sprintf(Error_message,"Sintax error in line %i : %s",Num_line,"One-Phase-Analysis (*, GPxElement=int)");
        standard_error(); 
     }
...
static int * assign_material_to_particles(
  char * Name_File,
  int NumMaterials, 
  int NumParticles, 
  int GPxElement)
  ...
  */
  ...
  while(fgets(Line,sizeof(Line),Sim_dat) != NULL)
  {
    ...
    */
    ...
    if ((Num_words >= 3) && (strcmp(Words[0],"Assign-material-to-particles") == 0))
    {
