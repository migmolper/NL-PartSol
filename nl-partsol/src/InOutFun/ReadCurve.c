  ...
  */
  ...
  if (Sim_dat == NULL) {
    fprintf(stderr, "%s : %s %s \n", "Error in ReadCurve()",
            "during the lecture of", Name_File);
    exit(EXIT_FAILURE);
  }
...
void fill_ConstantCurve(Curve DatCurve, char *Properties) {
  /*!
    Number of key words
  */
  int nparam;
...
void fill_RampCurve(Curve DatCurve, char *Properties) {
...
void fill_HeavisideCurve(Curve DatCurve, char *Property_1, char *Property_2) {
  /*!
    Number of key words
  */
  int nparam_1;
  ...
  */
  ...
  if ((strcmp(param_1[0], "SCALE") == 0) && (strcmp(param_2[0], "Tc") == 0)) {
    /*!
    ...
    */
    ...
    if ((Tc > DatCurve.Num) || (Tc < 0)) {
      fprintf(stderr, "%s : %s !!! \n", "Error in fill_HeavisideCurve()",
              "Tc is not in [0,Sizecurve]");
      exit(EXIT_FAILURE);
    }
...
void fill_DeltaCurve(Curve DatCurve, char *Property_1, char *Property_2) {
...
void fill_HatCurve(Curve DatCurve, char *Property_1, char *Property_2,
                   char *Property_3) {
...
void free_Curve(Curve A) { free(A.Fx); }
