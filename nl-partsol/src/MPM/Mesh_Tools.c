...
void GetInitialGaussPointPosition(Matrix X_p, Mesh FEM_Mesh, int GPxElement)
/*
 * 
 */
{
...
void get_particle_tributary_nodes(GaussPoint MPM_Mesh, Mesh FEM_Mesh, int p){
  ...
  if(strcmp(ShapeFunctionGP,"MPMQ4") == 0){
  ...
  else if(strcmp(ShapeFunctionGP,"LME-Anisotropic") == 0){
     ...
     */
    Beta_p = beta_anisotropic__LME__(Beta_p, Delta_Xip);
