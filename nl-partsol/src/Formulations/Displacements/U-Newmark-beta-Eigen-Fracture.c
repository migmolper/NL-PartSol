#include "Formulations/Displacements/U-Newmark-beta-Eigen-Fracture.h"
...
*/
static void compute_particle_Damage(int, Particle, Mesh);
/*******************************************************/
...
static void compute_particle_Damage(int p, Particle MPM_Mesh, Mesh FEM_Mesh) {
